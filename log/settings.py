...
SECRET_KEY = 'django-insecure-z&-x8ut-p!33t=2p1v5==n18s@=@2%@$ds4e6=%zkb=tc=21zt'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'com', 'templates')],  # Correct path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'hijangra77@gmail.com'  # अपना Gmail डालो
EMAIL_HOST_PASSWORD = 'bnwgcyjncpmbeidj'  # Gmail App Password डालो
import os
import os
from pathlib import Path
